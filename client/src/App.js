    ...
    <div className="home">
      <section>
        ...
        <p className="section-subtitle">
          Transform how you study with interactive tools and AI-powered aids.
        </p>
      </section>
      ...
      <section className="mission">
        ...
        <p>
          Our mission is to help students transform lecture materials, meetings,
          and videos into interactive, visual, and AI-powered study aids — like
          mindmaps, flashcards, and chatbot-driven Q&A — so that anyone can
    ...
    <Router>
      <div className="app-container">
        ...
        <div className="page-content container-fluid py-4">
          ...
          {message && (
            <p className="message text-success">Message: {message}</p>
          )}
